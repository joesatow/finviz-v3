    ...
    if 'chartConfig' in kwargs:
        ...
        if currentFilterVol == 200: # Big
            if kwargs['chartConfig'] == 'd':
                currentFolder = f"{currentDirectory}/webpage/charts/big-daily"
            if kwargs['chartConfig'] == 'w':
                currentFolder = f"{currentDirectory}/webpage/charts/big-weekly"
        else: # 20-100
            if kwargs['chartConfig'] == 'd':
                currentFolder = f"{currentDirectory}/webpage/charts/toh-daily"
            if kwargs['chartConfig'] == 'w':
                currentFolder = f"{currentDirectory}/webpage/charts/toh-weekly"
